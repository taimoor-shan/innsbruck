...
<body <?php body_class('bg-white text-zinc-900 antialiased'); ?>>
    ...
    <div id="page" class="min-h-screen flex flex-col">
        ...
        <nav
            ...
            <div class="ml-auto mr-auto w-full p-4">
                ...
                <section class="container mx-auto py-12">
                    <div class="max-w-(--breakpoint-md)">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 md:w-10 mb-4" viewBox="0 0 117.91 117.91">
                            ...
                            <path
                                d="M117.84 53.9c-1.32 8-3.79 14.85-7.42 20.55-3.63 5.7-8.02 10.09-13.18 13.16-5.16 3.07-10.72 4.6-16.7 4.6-4.5 0-8.05-.76-10.65-2.27-2.6-1.51-4.53-3.28-5.78-5.3s-2.19-3.82-2.8-5.4h-.92l-6.45 38.66h52.18c6.51 0 11.79-5.28 11.79-11.79V53.42c-.02.16-.05.31-.07.47Z" />
                            <path
                        ...
                        <div>
                            <a href="https://tailpress.io"
                                class="inline-flex rounded-full px-4 py-1.5 text-sm font-semibold transition bg-dark text-white hover:bg-dark/90 !no-underline">
                                Documentation
                            </a>
                        </div>
                    </div>

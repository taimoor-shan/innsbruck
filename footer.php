            ...
            <div class="col-span-1 md:col-span-3">
                ...
                <ul>
                    ...
                    <li class="items-start flex text-left mt-[12px]">
                        ...
                        <span class="block text-left ml-[12px] text-[14px] leading-[20px]"><a
                                href="mailto:<?php echo esc_attr($contact_email); ?>"
                                class="text-inherit no-underline hover:text-primary transition-colors"><?php echo esc_html($contact_email); ?></a></span>
                    </li>
                </ul>
            </div>
        </div>
